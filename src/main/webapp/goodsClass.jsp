...
<%
        ...
        GoodsClass goodsClassShow = (GoodsClass) request.getAttribute("goodsClassShow");
        GoodsClass goodsClassShow2 = (GoodsClass) request.getAttribute("goodsClassShow2");
...
<body>
    ...
    <div class="head">
        ...
        <!-----------------address------------------------------->
        <div class="address">
            <div class="wrapper clearfix"><a href="back/index.jsp">首页</a><span>/</span>
                <a href="/findGoodsClass?type=<%=type%>&classId1=<%=goodsClassShow.getId()%>&goodsName=<%=goodsClassShow.getClassName()%>" class="on">
