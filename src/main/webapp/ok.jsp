...
<body>
    ...
    <div class="order mt cart">
        <div class="site">
            <p class="wrapper clearfix"><span class="fl">支付成功</span><img class="top" src="img/temp/cartTop03.png"></p>
        </div>
        <p class="ok">支付成功！剩余<span>5</span>秒<a href="/myorderq">返回订单页</a></p>
    </div>
    <div class="like">
        <h4>猜你喜欢</h4>
        <div class="bottom">
    ...
    <div class="footer">
        ...
        <p class="dibu">泽庆家居&copy;为您的家庭增添一抹温馨<br/> 本网站所列数据仅作为学生作品展示 ， 学生作品如有侵权，请联系：15034344690</p>
    </div>
